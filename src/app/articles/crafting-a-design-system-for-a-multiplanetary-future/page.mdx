...
If I have learn one thing this summer while doing my internship at BNP Paribas CIB in Global Markets in the Technology Platforms team, it's that ensuring a good data quality is essential especially for a financial institution like a bank.

<Image src={designSystem} alt="" />

Errors in some data can end up in huge loss of money for the bank, which is why so much time and resources is allocated to data validation and outliers detection.
